...
$sql="delete from transaksi where idtransaksi=$_GET[id]";
if(mysqli_query($connect,$sql)) {
	echo "<script type=\"text/javascript\">window.alert('Delete Data Transaksi Berhasil.');window.location.href = 'admintransaksi.php';</script>"; 
}
else {}

...
$sql="delete from customer where idcustomer=$_GET[id]";
if(mysqli_query($connect,$sql)) {
	echo "<script type=\"text/javascript\">window.alert('Delete Data Customer Berhasil.');window.location.href = 'admincustomer.php';</script>"; 
}
else {}

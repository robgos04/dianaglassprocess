...
$sql="delete from warehouse where idwarehouse=$_GET[id]";
if(mysqli_query($connect,$sql)) {
	echo "<script type=\"text/javascript\">window.alert('Delete Data Gudang Berhasil.');window.location.href = 'adminwarehouse.php';</script>"; 
}
else {}

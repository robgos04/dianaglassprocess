...
<div class="col-md-12">	
		...
		<div id="daftar">
			<button type="button" id="create-user" class="btn btn-primary" >Input Data Supplier baru</button>
		</div>
		<br>
		
		<div id="dialog" title="Input Data Supplier">
			<form action="inputsupplier.php" method="POST" class="form-horizontal" enctype="multipart/form-data" role="form">
				<table width="100%">
				<tr>
					<td>
					...
					<input name="namasupplier" type="text" placeholder="Nama Supplier" class="form-control" id="namasupplier">
					</td>
				</tr>
				<tr>
					<td><br>
					<i style="color:black;">Alamat</i><br>
					<input name="alamat" type="text" placeholder="Alamat" class="form-control" id="alamat">
					</td>
				</tr>
				<tr>
					<td><br>
					<i style="color:black;">Contact person</i><br>
					<input name="contactperson" type="text" placeholder="Nama contact person" class="form-control" id="contactperson">
					</td>
				</tr>
				<tr>
					<td><br>
					<i style="color:black;">No Telepon</i><br>
					<input name="notelepon" type="text" placeholder="Nomor telepon" class="form-control" id="notelepon">
					</td>
				</tr>
				<tr>	
					<td>
	...
	<?php
	$result = mysqli_query ($con,"select * from supplier order by namasupplier ASC ");
	...
	if (!empty($result))
	{
			...
			/*	echo "<th>";
				echo "<strong>ID Supplier</strong>";
				echo "</th>"; */
				
				echo "<th class='tabjudul'>";
				echo "<strong>Nama Supplier</strong>";
				echo "</th>";
		...
		/*	echo "<td>";
			...
			echo "<td>";
			echo "<a href='deletesupplier.php?id=" . $row['idsupplier'] ."'>";
			echo "<button type='button' class='btn btn-danger btn-s'><span class='glyphicon glyphicon-trash'></span></button>";
			echo "</td>";
			
			echo "<td>";
			echo "<form action='editsupplier.php' method='post'>";
			echo "<input type='hidden' name='id' value=".$row['idsupplier']." ><button type='submit' class='btn btn-success btn-s'><span class='glyphicon glyphicon-pencil'></span></button></form>";
			echo "</td>";	
